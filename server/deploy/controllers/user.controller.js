...
import { createBrokerSchema, updateProfileSchema, } from '../validators/auth.validators.js';
...
export const userController = {
    ...
    async getBroker(req, res) {
        ...
        const user = await userService.getBroker(req.params.id, req.user.agencyId);
        res.json({ user });
    },
    ...
    async toggleStatus(req, res) {
        ...
        const user = await userService.toggleUserStatus(req.params.id, req.user.agencyId);
        res.json({ user });
    },
};
